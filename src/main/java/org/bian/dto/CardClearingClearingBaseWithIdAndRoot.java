...
/**
 * CardClearingClearingBaseWithIdAndRoot
 */
public class CardClearingClearingBaseWithIdAndRoot   {
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: refers to a specific card clearing end to end process  
