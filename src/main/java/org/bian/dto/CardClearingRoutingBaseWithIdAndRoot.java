...
/**
 * CardClearingRoutingBaseWithIdAndRoot
 */
public class CardClearingRoutingBaseWithIdAndRoot   {
  private String cardClearingRoutingTaskReference = null;
  ...
  private Object cardClearingRoutingTaskRecord = null;


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: refers to the transaction/batch routing task within the clearing process instance  
   * @return cardClearingRoutingTaskReference
  **/

  public String getCardClearingRoutingTaskReference() {
    return cardClearingRoutingTaskReference;
  }

  public void setCardClearingRoutingTaskReference(String cardClearingRoutingTaskReference) {
    this.cardClearingRoutingTaskReference = cardClearingRoutingTaskReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: processing record for the transaction/batch routing task within the clearing process instance  
   * @return cardClearingRoutingTaskRecord
  **/

  public Object getCardClearingRoutingTaskRecord() {
    return cardClearingRoutingTaskRecord;
  }

  public void setCardClearingRoutingTaskRecord(Object cardClearingRoutingTaskRecord) {
    this.cardClearingRoutingTaskRecord = cardClearingRoutingTaskRecord;
  }
