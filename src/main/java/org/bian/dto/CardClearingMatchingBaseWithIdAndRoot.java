...
/**
 * CardClearingMatchingBaseWithIdAndRoot
 */
public class CardClearingMatchingBaseWithIdAndRoot   {
  private String cardClearingMatchingTaskReference = null;
  ...
  private Object cardClearingMatchingTaskRecord = null;


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: refers to the transaction matching task within the clearing process instance  
   * @return cardClearingMatchingTaskReference
  **/

  public String getCardClearingMatchingTaskReference() {
    return cardClearingMatchingTaskReference;
  }

  public void setCardClearingMatchingTaskReference(String cardClearingMatchingTaskReference) {
    this.cardClearingMatchingTaskReference = cardClearingMatchingTaskReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: processing record for the transaction matching task within the clearing process instance  
   * @return cardClearingMatchingTaskRecord
  **/

  public Object getCardClearingMatchingTaskRecord() {
    return cardClearingMatchingTaskRecord;
  }

  public void setCardClearingMatchingTaskRecord(Object cardClearingMatchingTaskRecord) {
    this.cardClearingMatchingTaskRecord = cardClearingMatchingTaskRecord;
  }
