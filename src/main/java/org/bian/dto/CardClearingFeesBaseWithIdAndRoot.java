...
/**
 * CardClearingFeesBaseWithIdAndRoot
 */
public class CardClearingFeesBaseWithIdAndRoot   {
  private String cardClearingFeesTaskReference = null;
  ...
  private Object cardClearingFeesTaskRecord = null;


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: refers to the intercharge fee application task within the clearing process instance  
   * @return cardClearingFeesTaskReference
  **/

  public String getCardClearingFeesTaskReference() {
    return cardClearingFeesTaskReference;
  }

  public void setCardClearingFeesTaskReference(String cardClearingFeesTaskReference) {
    this.cardClearingFeesTaskReference = cardClearingFeesTaskReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: processing record for the intercharge fee application task within the clearing process instance  
   * @return cardClearingFeesTaskRecord
  **/

  public Object getCardClearingFeesTaskRecord() {
    return cardClearingFeesTaskRecord;
  }

  public void setCardClearingFeesTaskRecord(Object cardClearingFeesTaskRecord) {
    this.cardClearingFeesTaskRecord = cardClearingFeesTaskRecord;
  }
