...
/**
 * CardClearingReconciliationBaseWithIdAndRoot
 */
public class CardClearingReconciliationBaseWithIdAndRoot   {
  private String cardClearingReconciliationTaskReference = null;
  ...
  private Object cardClearingReconciliationTaskRecord = null;


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: refers to the transaction reconciliation task within the clearing process instance  
   * @return cardClearingReconciliationTaskReference
  **/

  public String getCardClearingReconciliationTaskReference() {
    return cardClearingReconciliationTaskReference;
  }

  public void setCardClearingReconciliationTaskReference(String cardClearingReconciliationTaskReference) {
    this.cardClearingReconciliationTaskReference = cardClearingReconciliationTaskReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: processing record for the transaction reconciliation task within the clearing process instance  
   * @return cardClearingReconciliationTaskRecord
  **/

  public Object getCardClearingReconciliationTaskRecord() {
    return cardClearingReconciliationTaskRecord;
  }

  public void setCardClearingReconciliationTaskRecord(Object cardClearingReconciliationTaskRecord) {
    this.cardClearingReconciliationTaskRecord = cardClearingReconciliationTaskRecord;
  }
