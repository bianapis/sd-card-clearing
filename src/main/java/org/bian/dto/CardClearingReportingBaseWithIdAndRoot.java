...
/**
 * CardClearingReportingBaseWithIdAndRoot
 */
public class CardClearingReportingBaseWithIdAndRoot   {
  private String cardClearingReportingTaskReference = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: refers to a reporting request task, here focusing on extracted card transaction details  
   * @return cardClearingReportingTaskReference
  **/

  public String getCardClearingReportingTaskReference() {
    return cardClearingReportingTaskReference;
  }

  public void setCardClearingReportingTaskReference(String cardClearingReportingTaskReference) {
    this.cardClearingReportingTaskReference = cardClearingReportingTaskReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: refers to the card transaction as recorded by network, issuer and/or acquirer 
