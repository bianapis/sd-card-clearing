...
/**
 * CardClearingCaptureBaseWithIdAndRoot
 */
public class CardClearingCaptureBaseWithIdAndRoot   {
  private String cardClearingCaptureTaskReference = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: refers to the transaction capture task within the clearing process instance  
   * @return cardClearingCaptureTaskReference
  **/

  public String getCardClearingCaptureTaskReference() {
    return cardClearingCaptureTaskReference;
  }

  public void setCardClearingCaptureTaskReference(String cardClearingCaptureTaskReference) {
    this.cardClearingCaptureTaskReference = cardClearingCaptureTaskReference;
  }
